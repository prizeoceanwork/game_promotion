...
export default function GamePreviewSocialBuildingGroup() {
  const { data: stats } = useQuery<StatsResponse>({
    queryKey: ["/api/stats"],
    queryFn: async () => {
      const res = await apiRequest("GET" ,"/api/socialbuildinggroup/stats");
  ...
  return (
    <section className="bg-gradient-to-br from-gray-800  to-gray-600  py-16" style={{ fontFamily: 'Montserrat, sans-serif' }}>
