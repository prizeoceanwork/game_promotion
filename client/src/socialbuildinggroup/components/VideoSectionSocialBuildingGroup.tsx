...
export default function VideoSectionSocialBuildingGroup({ onVideoComplete }: VideoSectionProps) {
    ...
    <section className="bg-white py-12">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-br from-gray-800  to-gray-600 text-white text-center py-4 md:py-6 rounded-t-lg shadow-lg">
                ...
                >
                  <div className="bg-white bg-opacity-90 rounded-full p-6 shadow-2xl">
                    {isLoading ? (
                      ...
                      <Play className="text-4xl text-bg-gradient-to-br from-gray-800  to-gray-600 ml-1" size={48} />
                    )}
                  </div>
                </button>
              )}
