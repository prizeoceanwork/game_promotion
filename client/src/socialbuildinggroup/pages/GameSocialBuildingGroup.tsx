...
import ScratchCardSocialBuildingGroup from "../components/ScratchCardSocialBuildingGroup";
...
export default function GameSocialBuildingGroup() {
 ...
 useEffect(() => {
  ...
  useEffect(() => {
    ...
    if (!regData) {
      ...
      setLocation('/socialbuildinggroup');
      return;
    }
            ...
            {Array.from({ length: 9 }).map((_, index) => (
              ...
              >
                ...
                {scratchedCells[index] ? (
                  ...
                  <ScratchCardSocialBuildingGroup
                    width={56} // w-14 = 56px
                    height={56}
                    scratchPercent={40}
