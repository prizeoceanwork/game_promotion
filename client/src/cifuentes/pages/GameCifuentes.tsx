...
{gameComplete && winnerCard && (
  ...
  >
    <div className="bg-gradient-to-br from-[#DEB406] via-[#DEB406]  to-[#10155E] p-3 rounded-2xl w-full max-w-md mx-3 shadow-2xl max-h-[90vh] overflow-y-auto">
      <div className="bg-white rounded-xl p-4 text-center relative overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-[#DEB406] via-[#DEB406]  to-[#10155E] text-white p-3 rounded-lg mb-4 shadow-md">
