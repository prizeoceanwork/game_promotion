...
import companyLogo1 from "../assets/Game-2(SofloPro Services)/Assets/SO FLO PRO LOGO 2 .png";
...
export default function Gamesoflopro() {
...
useEffect(() => {
  if (gameComplete && winnerCard && videoRef.current) {
    ...
    const hlsUrl =
      "https://res.cloudinary.com/dziy5sjas/video/upload/sp_auto/v1/Michael_Patrick_-_D4UP_Joint_Venture_Trailer_-_George_Villacres_V1_sspjvb.m3u8";
    ...
    <div className="min-h-screen bg-white">
      ...
      {showLosePopup && (
        <div className="fixed inset-0 bg-black bg-opacity-80 flex items-center justify-center z-50 p-4">
          <div className="bg-gradient-to-br from-[#FEC76B] via-[#FEA310] to-[#4150FF]  p-4 rounded-3xl max-w-md w-full mx-4 shadow-2xl animate-float">
      ...
      {showEmailPrompt && (
        <div className="fixed inset-0 bg-black bg-opacity-80 flex items-center justify-center z-50 p-3 sm:p-4 md:p-6">
          <div className="bg-gradient-to-br from-[#FEC76B] via-[#FEA310] to-[#4150FF]  p-3 sm:p-4 md:p-5 rounded-3xl max-w-sm sm:max-w-md w-full mx-3 sm:mx-4 shadow-2xl">
    ...
    <div className="bg-gradient-to-br from-[#FEC76B] via-[#FEA310] to-[#4150FF]  p-3 rounded-2xl w-full max-w-md mx-3 shadow-2xl max-h-[90vh] overflow-y-auto">
      <div className="bg-white rounded-xl p-4 text-center relative overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white p-3 rounded-lg mb-3 shadow-md">
          ...
          <div
            className="bg-gradient-to-r from-green-500 to-green-600 text-white p-2 rounded shadow-inner"
          >
            <p
