import Headersoflopro from "../components/Headersoflopro";
import VideoSectionsoflopro from "../components/VideoSectionsoflopro";
import GamePreviewsoflopro from "../components/GamePreviewsoflopro";
import RegistrationFormsoflopro from "../components/RegistrationFormsoflopro";
          ...
          <div className="max-w-10xl mx-auto">
            ...
            <div className="flex justify-center mb-8">
              <div className="flex  space-x-1">
                {[...Array(5)].map((_, i) => (
                  <div key={i} className="w-6 h-6 md:w-8 md:h-8 text-[#4150FF]">
           ...
           OUR SHARED VISION TO PROVIDE HOMEOWNERS EXCEPTIONAL SERVICES BROUGHT US TOGETHER!
            ...
            <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl text-white font-semibold mb-8 px-4" style={{ fontFamily: 'Montserrat, sans-serif' }}>
              ...
              <span className="text-[#4150FF] font-black block sm:inline"> $5 Million</span> in Instant Prizes!
            </p>
          </div>
        </div>
      </section>

      <VideoSectionsoflopro onVideoComplete={() => setVideoWatched(true)} />
      <GamePreviewsoflopro />
      <RegistrationFormsoflopro videoWatched={videoWatched} />
      <Footersoflopro />
    </div>
  );
}
