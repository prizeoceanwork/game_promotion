...
import TermsAndConditionssoflopro from "./TermsAndConditionssoflopro";
import PrivacyPolicysoflopro from "./PrivacyPolicysoflopro";
...
export default function RegistrationFormsoflopro({
  videoWatched,
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-12">
            <div className="inline-block p-4 bg-gradient-to-r from-[#FEA310] to-[#4150FF] rounded-full mb-8 shadow-xl">
          ...
          {/* Registration Form */}
          <div className="bg-gradient-to-br from-[#FEA310] to-[#4150FF] rounded-2xl shadow-2xl p-2">
            <div className="bg-white rounded-xl p-8 shadow-inner relative">
              {/* Play Now badge */}
              <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 bg-gradient-to-br from-[#FEA310] to-[#4150FF] text-white px-6 py-2 rounded-full shadow-lg">
                <span
  ...
  <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-60 p-4">
    <div className="bg-white rounded-2xl shadow-2xl w-full max-w-3xl max-h-[80vh] overflow-y-auto relative p-6">
      ...
      {/* Modal content */}
      {openModal === "terms" && <TermsAndConditionssoflopro />}
      {openModal === "privacy" && <PrivacyPolicysoflopro />}
    </div>
  </div>
)}
