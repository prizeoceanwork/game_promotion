...
export default function VideoSectionCifuentes({ onVideoComplete }: VideoSectionProps) {
    ...
    <section className="bg-white py-12">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-r from-[#DEB406]  to-[#10155E] text-white text-center py-4 md:py-6 rounded-t-lg shadow-lg">
                ...
                >
                  <div className="bg-white bg-opacity-90 rounded-full p-6 shadow-2xl">
                    {isLoading ? (
                      ...
                      <Play className="text-4xl text-[#10155E] ml-1" size={48} />
                    )}
                  </div>
                </button>
              )}
