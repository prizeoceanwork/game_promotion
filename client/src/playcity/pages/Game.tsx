...
export default function GamePlayCity() {
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="text-center py-8 px-4 bg-white">
        <div className="max-w-5xl mx-auto">
          <h1
            className="text-3xl md:text-3xl lg:text-3xl text-blue-600 font-bold mb-2"
            style={{
              ...wayComeFontStyle,
          ...
          <h1
            className="text-3xl md:text-3xl lg:text-3xl text-blue-600 font-bold mb-6"
            style={{
              ...wayComeFontStyle,
          ...
          <h2
            className="text-2xl md:text-2xl lg:text-2xl text-blue-400 font-bold"
            style={{
              ...wayComeFontStyle,
      ...
      {showLosePopup && (
        <div className="fixed inset-0 bg-black bg-opacity-80 flex items-center justify-center z-50 p-4">
          <div className="bg-[#868686] p-4 rounded-3xl max-w-md w-full mx-4 shadow-2xl animate-float">
      ...
      {showEmailPrompt && (
        <div className="fixed inset-0 bg-black bg-opacity-80 flex items-center justify-center z-50 p-3 sm:p-4 md:p-6">
          <div className="bg-[#868686]  p-3 sm:p-4 md:p-5 rounded-3xl max-w-sm sm:max-w-md w-full mx-3 sm:mx-4 shadow-2xl">
      ...
      {gameComplete && winnerCard && (
        ...
        >
          <div className="bg-[#868686]  p-3 rounded-2xl w-full max-w-md mx-3 shadow-2xl max-h-[90vh] overflow-y-auto">
            <div className="bg-white rounded-xl p-4 text-center relative overflow-hidden">
              ...
              <div className="bg-[#868686] text-white p-3 rounded-lg mb-4 shadow-md">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4 md:p-6">
          <div className="bg-white p-6 sm:p-8 md:p-10 rounded-lg text-center max-w-md md:max-w-lg mx-4 shadow-2xl">
            ...
            <div className="flex space-x-4 md:space-x-6">
              ...
              <Button
                onClick={() => setLocation("/appliancegallery")}
                variant="outline"
