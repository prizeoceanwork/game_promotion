...
import companyLogo from "../assets/Play City logo.jpg";
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="relative bg-[linear-gradient(to_bottom_right,_#4AC9F6_0%,_#1E90FF_25%,_#F7902B_55%,_#FF6600_100%)] py-16 md:py-20 overflow-hidden">
