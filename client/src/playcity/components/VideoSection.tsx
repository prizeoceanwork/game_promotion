    ...
    <section className="bg-white py-12">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          <div className="bg-[linear-gradient(to_right,_#4AC9F6_0%,_#1E90FF_25%,_#F7902B_55%,_#FF6600_100%)] text-white text-center py-4 md:py-6 rounded-t-lg shadow-lg">
                ...
                >
                  <div className="bg-white bg-opacity-90 rounded-full p-6 shadow-2xl">
                    {isLoading ? (
                      ...
                      <Play className="text-4xl text-blue-500 = ml-1" size={48} />
                    )}
                  </div>
                </button>
              )}
