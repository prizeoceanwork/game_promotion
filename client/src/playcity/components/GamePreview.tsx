...
export default function GamePreview() {
  const { data: stats } = useQuery<StatsResponse>({
    queryKey: ["/api/stats"],
    queryFn: async () => {
      const res = await apiRequest("GET" ,"/api/playcity/stats");
  ...
  return (
    <section className="bg-[linear-gradient(to_bottom_right,_#4AC9F6_0%,_#1E90FF_25%,_#F7902B_55%,_#FF6600_100%)]  py-16" style={{ fontFamily: 'Montserrat, sans-serif' }}>
